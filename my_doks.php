...
include 'head.php';
?>
<title>Äîáàâëåíèå äîêóìåíòîâ</title>
...
echo '<p style="color:#135B00; text-align: center"><b>Äîêóìåíò óñïåøíî äîáàâëåí!</b></p><br />';
...
<div class="tabs">
		...
		<TR><TD colspan=2><TEXTAREA NAME='text' data-editor="rich" COLS=55 ROWS=10 required></TEXTAREA></TD></TR>
		<TR><TD colspan=2><TEXTAREA NAME='text' data-editor="rich" COLS=55 ROWS=10 required></TEXTAREA></TD></TR>
        <li><a class="" href="#cirk">Öèðêóëÿð</a></li>
        <li><a class="" href="#fift">Óäîñòîâåðåíèå</a></li>
    </ul>
<!-- Ýòî êîíòåéíåðû ñîäåðæèìîãî -->    
    <div id="first">
<span class="table">
 ...
 <INPUT TYPE="HIDDEN" NAME="tematika" VALUE ="ukaz">
		...
		<TR><TD VALIGN=top><b>Êîìó âûäàí äîêóìåíò:</B></TD><TD></TD></TR>
...
<span class="table">
 ...
 <INPUT TYPE="HIDDEN" NAME="tematika" VALUE ="raspor">
		...
		<TR><TD VALIGN=top><b>Íîìåð äîêóìåíòà:</B></TD><TD></TD></TR>
...
<span class="table">
	<TABLE CELLSPACING=3 CELLPADDING=2 width='400' align='center' border=0>
        <FORM ACTION='my_doks.php' method='post'>
				<TR><TD VALIGN=top><b>Ñàí:</B></TD><TD></TD></TR>

		<TR><TD VALIGN=top>
 <INPUT TYPE="HIDDEN" NAME="tematika" VALUE ="udostoverenie">
		<input type='radio' name='san' value='äèàêîíà' checked id="diak"><label for="diak">äèàêîíà</label><br />
		<input type='radio' name='san' value='ïðåñâèòåðà' id="ierei"><label for="ierei">ïðåñâèòåðà</label><br />
